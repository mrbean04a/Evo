...
class Brain:
    def __init__(self):
        ...
        try:
            ...
            print(f"Knowledge base file '{Config.KNOWLEDGE_BASE_PATH}' is missing or empty.")
            self.knowledge_base = []
...
if __name__ == "__main__":
    ...
    print("Chatbot is ready. Type your queries or 'exit' to quit.")
    ...
    while True:
        ...
        response = brain.handle_query(user_id, user_input)
